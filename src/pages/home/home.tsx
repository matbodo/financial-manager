        ...
        <>
            <div className="flex min-h-screen w-full items-center justify-center bg-emerald-950 px-4 py-8">
                <div className="mx-auto flex w-full max-w-5xl flex-col gap-5">
                    <section className="mb-3 grid gap-4 rounded-2xl border border-emerald-700 bg-emerald-50 p-5 shadow-sm sm:grid-cols-3 sm:p-6">
                        <div className="rounded-xl border border-emerald-300 bg-white p-5 shadow-sm">
                            ...
                            <div className=" relative mt-4">
                                <input
                                    ...
                                    className="h-14 w-full rounded-xl border border-emerald-300 bg-emerald-50 px-4 text-2xl font-bold text-emerald-700 transition placeholder:text-gray-400 focus:border-emerald-500 focus:bg-white focus:ring-4 focus:ring-emerald-100"
                                />
                        ...
                        <div className="rounded-xl border border-emerald-300 bg-emerald-600 p-5 shadow-sm">
                            <h1 className="text-sm font-bold uppercase tracking-wide text-emerald-950">GASTO TOTAL</h1>
                        ...
                        <div className="rounded-xl border border-emerald-300 bg-emerald-900 p-5 shadow-sm">
                            <h1 className="text-sm font-bold uppercase tracking-wide text-emerald-200">SALDO DISPONÍVEL</h1>
                ...
                <span
                    className="fixed bottom-4 right-4 rounded-full bg-red-500 px-3 py-2 text-sm font-bold text-white shadow-lg transition hover:bg-red-700"
