            ...
            <div className="min-h-screen w-full bg-emerald-950 px-4 py-8">
                <div className="mx-auto min-h-screen w-full max-w-5xl">
                    ...
                    <div className="flex flex-col items-center">
                        {openForm ? (
                            <button className="mt-4 flex min-h-32 w-full items-center justify-center rounded-2xl border  border-emerald-300 bg-emerald-50 p-6 shadow-sm transition hover:bg-emerald-950 animate-[formIn_180ms_ease-out]"
                        ...
                        <div className="mt-8 flex w-full flex-col gap-4">
                            {investmentStorage.map((investment, index) => (
                                <div key={index} className="relative min-h-32 w-full rounded-2xl border border-gray-200 bg-emerald-50 p-6 shadow-sm">
